...
return new class extends Migration
{
    ...
    {
        \Illuminate\Support\Facades\DB::table('users')->whereIn('email', ['admin123@alitech.com', 'user123@alitech.com'])->delete();
    }
};
